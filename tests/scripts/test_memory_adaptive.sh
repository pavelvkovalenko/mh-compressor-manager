...
log "=========================================================================="
log "⚠️  ВНИМАНИЕ: Адаптивное управление памятью НЕ реализовано в программе."
log "Этот тест запускает 4 идентичных конфигурации для демонстрации формата."
log "Реальное сравнение стратегий возможно только после реализации пула памяти"
log "с настраиваемыми параметрами pool_size, pool_shrink_interval и т.д."
log ""
...
# TODO: Реализовать pool_size в конфигурации и коде программы
# ---------------------------------------------------------------------------
...
# TODO: Реализовать pool_shrink_interval в конфигурации и коде программы
# ---------------------------------------------------------------------------
