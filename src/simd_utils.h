 ...
 * 
 * Оптимизации:
 * - AVX2/AVX-512 ускорение для копирования памяти
...
public:
    /**
     * Быстрое копирование памяти с использованием AVX2
    ...
    /**
     * Быстрое обнуление памяти с использованием AVX2
...
private:
    // Вспомогательная функция для CPUID
